...
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/QOy6mM9pj/model.json',modelLoaded);
...
if (error) {
    ...
    toSpeak="";
    if
    (gesture == "amazing") { toSpeak = "This is looking amazing";
